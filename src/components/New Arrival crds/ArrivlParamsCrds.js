...
function ParamsCrds() {
  const [arrivlCrd, setArrivlCrd] = useState();
  ...
  useEffect(() => {
    const arrivlDetail = arrival.filter((card) => card?.id === dataID);
    setArrivlCrd(arrivlDetail[0]);
    console.log(arrivlDetail, "prod");
